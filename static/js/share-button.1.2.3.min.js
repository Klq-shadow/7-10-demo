    ...
    share: function () {
      var t = this.getAttribute("sharer").toLowerCase(),
        ...
        e = {
          ...
          reddit: { shareUrl: "https://www.reddit.com/submit", params: { url: url } },
